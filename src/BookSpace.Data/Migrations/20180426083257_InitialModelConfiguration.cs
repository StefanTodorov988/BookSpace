...
{
    public partial class InitialModelConfiguration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicationYear = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(nullable: false),
                    BanEndTime = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2018, 4, 26, 11, 32, 57, 779, DateTimeKind.Local)),
                    LastLogin = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2018, 4, 26, 11, 32, 57, 779, DateTimeKind.Local)),
                    LockOutEndTime = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2018, 4, 26, 11, 32, 57, 779, DateTimeKind.Local)),
                    RegistrationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2018, 4, 26, 11, 32, 57, 776, DateTimeKind.Local))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookId = table.Column<string>(nullable: false),
                    UserId = table.Column<string>(nullable: false),
                    IsRead = table.Column<bool>(nullable: true, defaultValue: false)
                },
                constraints: table =>
                {
